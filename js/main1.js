(() => {       
    ...
    function setCanvasImages() {
        let imgElem;
        for (let i = 0; i < sceneInfo[0].values.videomImageCount; i++) {
            imgElem = new Image();
            imgElem.src = `./video/001/IMG_${6726 + i}.JPG`;
            sceneInfo[0].objs.videoImages.push(imgElem);
        }
        let imgElem2;
        for (let i = 0; i < sceneInfo[2].values.videomImageCount; i++) {
            imgElem2 = new Image();
    ...
    function playAnimation() {
        ...
        switch (currentScene) {
            ...
            case 3:
                //상황에 따라 sticky와 sticky를 풀 때 필요한 스텝값들
                let step = 0;
                ...
                //캔버스가 브라우저 상단에 닿는 조건으로 분기
                if (scrollRatio < values.rect1X[2].end) {
                    step = 1;
                    objs.canvas.classList.remove('sticky');
                    // console.log('캔버스가 인닿았다.')
                } else {
                    step = 2;
                    ...
                    if (scrollRatio > values.canvas_scale[2].end && values.canvas_scale[2].end > 0) {
                        ...
                        values.canvasCaption_translateY[2] = values.canvasCaption_opacity[2];
                        
                        objs.canvasCaption.style.opacity = calcValues(values.canvasCaption_opacity, currentYOffset);
                        objs.canvasCaption.transform = `translate3d(0, ${values.canvasCaption_tarnslateY}%, 0)`;
                    }
                }
                break;
        }
